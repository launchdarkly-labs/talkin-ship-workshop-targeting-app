  ...
  return (
    <>
      {isDialogOpen ? (
        <Dialog>
          <DialogTrigger
            className={`w-full h-full p-1  font-shone rounded-none airlinesbordergradient text-xl border-4 text-black mt-4 hover:bg-gradient-airways-grey hover:text-white`}
          >
            Quick Login
          </DialogTrigger>
